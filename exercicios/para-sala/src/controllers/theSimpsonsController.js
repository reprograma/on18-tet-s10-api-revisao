 ...
 * 
 ...
 delimitar campos ex: trazer só o nome,
 paginação: 10 itens por request || 50 por request
 params -> pode ser um id, um cpf, cnpj
 query -> para a pesquisa
...
const obterPersonagens = async(request, response) =>{
    ...
    // caso o usuário não tenha passado parametros, retornamos tudo.
    ...
    for (const personagem of personagens){
        ...
        //ele vai percorrer cada chave do personagem atual do laço
